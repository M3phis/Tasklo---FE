            ...
            <div className="quick-edit-backdrop" onClick={handleBackdropClick}>
                ...
                >
                    ...
                    <div className={`quick-edit-actions ${menuSideClass}`}>
                        ...
                        <button ref={labelsButtonRef} className={`action-button ${activeModal === MODAL_TYPES.LABELS ? 'active' : ''}`} onClick={() => openModal(MODAL_TYPES.LABELS, labelsButtonRef)}>
                        ...
                        <button ref={membersButtonRef} className={`action-button ${activeModal === MODAL_TYPES.MEMBERS ? 'active' : ''}`} onClick={() => openModal(MODAL_TYPES.MEMBERS, membersButtonRef)}>
                        ...
                        <button ref={datesButtonRef} className={`action-button clock-icon ${activeModal === MODAL_TYPES.DATES ? 'active' : ''}`} onClick={() => openModal(MODAL_TYPES.DATES, datesButtonRef)}><ClockIcon label="Edit dates" color="172B4D" /><span>Edit dates</span></button>
                        ...
                        <button className="action-button">
                            ...
                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M5 16V4.99188C5 3.8918 5.90195 3 7.00853 3H14.9915L15 3.00002V5H7V16H5ZM8 19C8 20.1046 8.89543 21 10 21H18C19.1046 21 20 20.1046 20 19V8C20 6.89543 19.1046 6 18 6H10C8.89543 6 8 6.89543 8 8V19ZM10 8V19H18V8H10Z" fill="172B4D"></path></svg>
                            <span>Copy card</span></button>

                        <button className={`action-button delete-icon ${activeModal === 'DELETE' ? 'active' : ''}`} onClick={() => onRemoveTask(group.id, task.id)}><DeleteIcon label="Delete" color="currentColor" /><span>Delete</span></button>
